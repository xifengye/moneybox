...
@interface AddressSelectController : UIViewController<UITableViewDelegate,UITableViewDataSource,AddressSelectDelegate>
...
@property(nonatomic,weak)id<AddressSelectDelegate> delegate;
@end
